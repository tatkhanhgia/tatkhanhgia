...
public class QuanLyDiemThi_NhapDiem extends JFrame{
    private String a,b;     //Biến để lưu phòng thi và khóa thi truyền vào khi tạo constructor
    DefaultTableModel model;
    JTable tblDSSV;
    JScrollPane jScrollPane1;
    JTextField sobaodanh, khoathitxt, nghe,noi,doc,timkiem3,viet;
    int press = -1;    
    Vector header;
    DiemthiBUS bus;
    PhongthiDTO phongthi;
    
   public QuanLyDiemThi_NhapDiem(String phongthi,String khoathi) {   
        this.a = phongthi;this.b = khoathi;
        this.phongthi = new PhongthiDTO();
        this.phongthi.setPhongthi(phongthi);
        this.phongthi.setKhoathi(khoathi);
...
//Label head
        ...
        label1.setText("Nhập điểm Phòng thi "+this.phongthi.getPhongthi());
...
// khung chứa nhập dl- nút
        ...
        nhapdiem.setBounds(600, 100, 150, 35);
...
//        panel3.add(taidl);
        ...
        bus = new DiemthiBUS();
        ArrayList result = bus.get_diemthi_Phongthi(this.a, this.b);
   ...
   public void them(){   
      ...
      ArrayList result = thisinhbus.get_thisinh_theo_phongthi(this.a, this.b);
      QuanLyDiemThi_Frame_Nhapdiem a = new QuanLyDiemThi_Frame_Nhapdiem(result);
      a.run();
   ...
   public static void main(String[] args){       
       QuanLyDiemThi_NhapDiem a = new QuanLyDiemThi_NhapDiem("B1P03","Khoa001");
       a.run();
   }
}
